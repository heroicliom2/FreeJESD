...
// scrambler.sv's header for the shared bit/octet ordering convention,
// DW_OCTETS (compile-time datapath width) parameter, and verification
// status (all apply identically here).
...
module descrambler #(
    ...
    input  logic        rst_n,
    input  logic        valid_i,
    input  logic [DW_OCTETS*8-1:0] data_i,   // scrambled octet stream
    input  logic [DW_OCTETS-1:0]   ctrl_i,
    input  logic        enable_i,
    output logic        valid_o,
    output logic [DW_OCTETS*8-1:0] data_o,   // descrambled octet stream
